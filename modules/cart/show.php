...
<div class="container main-cart-show">
    ...
    <div class="row cart-left">
            ...
            <form action="?mod=cart&act=update" method="POST">
                ...
                <?php if (!empty($_SESSION['cart']['buy'])) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12  text-start py-5">
        ...
        <?php if (isset($_SESSION['cart'])) { ?>
            <div class="">
                <div class=" cart-header-info text-start">
                    <span>Thông tin đơn hàng</span>
                </div>
                <div class="card-body cart-info-body">
                    <div class="row ">
                        <div class="col-md-6">
                            <span class="d-block text-start pb-3 cart-border-top">Tổng tiền sản phẩm</span>
                            <span class="d-block text-start cart-border-top">Tổng số lượng</span>
                        </div>
                        <div class="col-md-6 ">
                            <span class="d-block text-end pb-3 cart-border-top"><?php echo number_format(get_total_order())  . "đ" ?></span>
                            <span class="d-block text-end cart-border-top"><?php echo get_num_order() ?></span>
                        </div>
                    </div>
                </div>
                <div class=" cart-info-footer">
                    <div class="row">
                        <div class="col-md-6 text-start cart-border-top"><span>Tổng thanh toán</span></div>
                        <div class="col-md-6 text-end total-pay cart-border-top"><span><?php echo number_format(get_total_order())  . "đ" ?></span></div>
